    ...
    <section className="flex items-center">
      <div className="md:max-w-2xl m-auto px-4 pt-0 py-16 lg:flex items-center sm:px md:px-20">
        <div className="text-center">
          ...
          <p className='pb-4'>Thanks for taking the time to review my portfolio. I'm happy to connect with colleagues or employers in the industry. I look forward to hearing from you.</p>
          <div>
