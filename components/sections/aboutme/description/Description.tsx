  ...
  return (
    <div className=''>
      <p className="text-primary-light">
        I'm from the National University San Antonio Abad del Cusco. I specialize in <span className="text-primary-light" style={{fontWeight :'600'}}>software development</span> and <span className="text-primary-light" style={{fontWeight :'600'}}>machine learning</span> and have gained valuable experience through participating in <span className="text-primary-light" style={{fontWeight :'600'}}>coding competitions</span>.
      </p>
      <p className="text-primary-light">
      ...
      <p className="text-primary-light hidden lg:block">
