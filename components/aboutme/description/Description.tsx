  ...
  return (
    <div>
      <p className={styles.text}>
        I am a recent graduate in Computer Science from the National University San Antonio Abad del Cusco. I specialize in software development and machine learning and have gained valuable experience through participating in coding competitions. 
      </p>
      <p className={styles.text}>
